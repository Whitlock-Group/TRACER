...
atlas_folder = '/Users/jingyig/Work/Kavli/PyCode/vitlab/racer/waxholm_atlas'

def tracer_atlas_loader(atlas_folder, atlas_version='v3'):
    ...
    # Labels #
    labels_item = open(os.path.join(atlas_folder, 'WHS_SD_rat_atlas_%s.label' % atlas_version), "r")
